...
![](https://github.com/TesrabNetwork/tesrab-documentation/tree/83a07bf2226d3becb757f0eacde10c6356fcfced/_assets/DEX1.png)Figure 1
...
## 3. Installing DEX {#Decentralizedcryptocurrencyexchange(DEX)-InstallingDEX}

* Download the Tesrab client from our official website,

  [https://tesrab.network](http://tesrab.network/) available soon

  , or use the webwallet, available at

  [beta.tesrab.network](https://beta.tesrab.network/)

* [Deposit your bitcoins](https://github.com/TesrabNetwork/tesrab-documentation/tree/83a07bf2226d3becb757f0eacde10c6356fcfced/tesrab-client/transfers-and-gateways/bitcoin-transfers.md) or any [supported coins and tokens](https://github.com/TesrabNetwork/tesrab-documentation/tree/83a07bf2226d3becb757f0eacde10c6356fcfced/platform%20features/tesrab-client/wallet-management.md) into the wallet and [start trading using the Tesrab DEX](https://github.com/TesrabNetwork/tesrab-documentation/tree/83a07bf2226d3becb757f0eacde10c6356fcfced/tesrab-client/tesrab-dex.md).
